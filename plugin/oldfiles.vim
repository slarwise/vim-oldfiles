...
command! -bang -complete=customlist,Oldfiles#Complete -nargs=+
            \ Oldfile call Oldfiles#EditFirstMatchingOldfile(<q-args>, 'edit', <q-mods>, <q-bang>)
command! -complete=customlist,Oldfiles#Complete -nargs=+
            \ Soldfile call Oldfiles#EditFirstMatchingOldfile(<q-args>, 'split', <q-mods>, '')
command! -complete=customlist,Oldfiles#Complete -nargs=+
            \ Voldfile call Oldfiles#EditFirstMatchingOldfile(<q-args>, 'vsplit', <q-mods>, '')
